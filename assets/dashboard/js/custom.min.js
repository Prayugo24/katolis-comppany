      ...
      .trigger("blur"),
			...
			$(function () {
				function resetSidebar() {
					...
					$("#sidebarnav li > a").removeClass("active").attr("aria-expanded", "false");
					$("#sidebarnav li > ul").removeClass("in").attr("aria-expanded", "false");
				}
			
				// Klik pada menu yang PUNYA anak (nested)
				$("#sidebarnav li ul li a").on("click", function (e) {
					resetSidebar();
					var $clickedLi = $(this).closest("li"); // li anak
					var $parentLi = $clickedLi.closest("li"); // li utama
					var $parentA = $parentLi.children("a");
					var $parentUl = $parentLi.children("ul");
			
					$parentLi.addClass("active");
					$parentA.addClass("active").attr("aria-expanded", "true");
